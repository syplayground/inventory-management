          ...
          <table class="orders-table submitted-orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-date">{{ formatDate(order.expected_delivery) }}</td>
                <td class="col-supplier">{{ order.supplier }}</td>
                <td class="col-value"><strong>{{ currencySymbol }}{{ order.total_value.toLocaleString() }}</strong></td>
              </tr>
            </tbody>
          </table>
...
export default {
  ...
  setup() {
    ...
    // Submitted orders are internal restocking orders created from the Restocking view.
    // Partitioned client-side from the already-loaded orders list (no separate API call).
